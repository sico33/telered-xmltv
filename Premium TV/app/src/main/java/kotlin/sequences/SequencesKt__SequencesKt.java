...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C00551<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C00551(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C00551> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00551 c00551 = new C00551(this.$this_ifEmpty, this.$defaultValue, continuation);
            c00551.L$0 = obj;
            return c00551;
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C00551(sequence, defaultValue, null));
    }
    ...
    static final class C00561<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00561(Sequence<? extends T> sequence, Random random, Continuation<? super C00561> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00561 c00561 = new C00561(this.$this_shuffled, this.$random, continuation);
            c00561.L$0 = obj;
            return c00561;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00561 = this;
                    SequenceScope sequenceScope2 = (SequenceScope) c00561.L$0;
                    sequenceScope = sequenceScope2;
                    mutableList = SequencesKt.toMutableList(c00561.$this_shuffled);
                    break;
                case 1:
                    c00561 = this;
                    mutableList = (List) c00561.L$1;
                    SequenceScope sequenceScope3 = (SequenceScope) c00561.L$0;
                    ResultKt.throwOnFailure(obj);
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c00561.$random.nextInt(mutableList.size());
                ...
                c00561.L$0 = sequenceScope;
                c00561.L$1 = mutableList;
                c00561.label = 1;
                if (sequenceScope.yield(objRemoveLast, c00561) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C00561(sequence, random, null));
    }
    ...
    static final class C00511<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00511(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C00511> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00511 c00511 = new C00511(this.$source, this.$transform, this.$iterator, continuation);
            c00511.L$0 = obj;
            return c00511;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00511 = this;
                    sequenceScope = (SequenceScope) c00511.L$0;
                    i = 0;
                    it = c00511.$source.iterator();
                    break;
                case 1:
                    c00511 = this;
                    i = c00511.I$0;
                    it = (Iterator) c00511.L$1;
                    sequenceScope = (SequenceScope) c00511.L$0;
                    ResultKt.throwOnFailure(obj);
                    break;
                default:
            ...
            while (it.hasNext()) {
                Object next = it.next();
                Function2<Integer, T, C> function2 = c00511.$transform;
                int i2 = i + 1;
                if (i < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                Object objInvoke = function2.invoke(Boxing.boxInt(i), (T) next);
                c00511.L$0 = sequenceScope;
                c00511.L$1 = it;
                c00511.I$0 = i2;
                c00511.label = 1;
                if (sequenceScope.yieldAll(c00511.$iterator.invoke((C) objInvoke), c00511) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                i = i2;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C00511(source, transform, iterator, null));
    }
