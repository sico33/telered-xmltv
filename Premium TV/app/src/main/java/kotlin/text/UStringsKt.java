...
public final class UStringsKt {
    ...
    public static final String m1596toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1598toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1597toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1595toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m388constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m306boximpl(UByte.m312constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m388constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m566boximpl(UShort.m572constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m388constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m641uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            int result2 = UInt.m388constructorimpl(result * uradix);
            result = UInt.m388constructorimpl(UInt.m388constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m382boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m466constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m643ulongDivideeb3DHEI(-1L, uradix);
                if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            long result2 = ULong.m466constructorimpl(result * uradix);
            result = ULong.m466constructorimpl(ULong.m466constructorimpl(((long) UInt.m388constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m460boximpl(result);
    }
}
