...
public final class Regex implements Serializable {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C00781(input, limit, null));
    }
    ...
    static final class C00781 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00781(CharSequence charSequence, int i, Continuation<? super C00781> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00781 c00781 = Regex.this.new C00781(this.$input, this.$limit, continuation);
            c00781.L$0 = obj;
            return c00781;
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c00781 = this;
                    SequenceScope $this$sequence2 = (SequenceScope) c00781.L$0;
                    matcher = Regex.this.nativePattern.matcher(c00781.$input);
                    if (c00781.$limit == 1 || !matcher.find()) {
                        c00781.label = 1;
                        return $this$sequence2.yield(c00781.$input.toString(), c00781) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    $this$sequence = $this$sequence2;
                    splitCount = 0;
                    nextStart = 0;
                    c00781.L$0 = $this$sequence;
                    c00781.L$1 = matcher;
                    c00781.I$0 = splitCount;
                    c00781.label = 2;
                    if ($this$sequence.yield(c00781.$input.subSequence(nextStart, matcher.start()).toString(), c00781) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00781.$limit - 1 || !matcher.find()) {
                        c00781.L$0 = null;
                        c00781.L$1 = null;
                        c00781.label = 3;
                        if ($this$sequence.yield(c00781.$input.subSequence(nextStart, c00781.$input.length()).toString(), c00781) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                ...
                case 2:
                    c00781 = this;
                    splitCount = c00781.I$0;
                    matcher = (Matcher) c00781.L$1;
                    $this$sequence = (SequenceScope) c00781.L$0;
                    ResultKt.throwOnFailure($result);
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00781.$limit - 1) {
