...
public class CollectionsKt__MutableCollectionsKt extends CollectionsKt__MutableCollectionsJVMKt {
    ...
    public static final <T> boolean removeAll(Collection<? super T> collection, Sequence<? extends T> elements) {
        ...
        return !collectionConvertToSetForSetOperation.isEmpty() && collection.removeAll(collectionConvertToSetForSetOperation);
    }

    public static final <T> boolean removeAll(Collection<? super T> collection, T[] elements) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        Intrinsics.checkNotNullParameter(elements, "elements");
        return !(elements.length == 0) && collection.removeAll(BrittleContainsOptimizationKt.convertToSetForSetOperation(elements));
    }
