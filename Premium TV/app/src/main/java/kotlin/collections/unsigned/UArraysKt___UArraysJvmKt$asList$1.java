...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object element) {
        if (element instanceof UInt) {
            return m797containsWZ4Q5Ns(((UInt) element).getData());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int index) {
        return UInt.m382boximpl(m798getpVg5ArA(index));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object element) {
        if (element instanceof UInt) {
            return m799indexOfWZ4Q5Ns(((UInt) element).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object element) {
        if (element instanceof UInt) {
            return m800lastIndexOfWZ4Q5Ns(((UInt) element).getData());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UIntArray.m448getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UIntArray.m450isEmptyimpl(this.$this_asList);
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public boolean m797containsWZ4Q5Ns(int element) {
        return UIntArray.m443containsWZ4Q5Ns(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-pVg5ArA, reason: not valid java name */
    public int m798getpVg5ArA(int index) {
        return UIntArray.m447getpVg5ArA(this.$this_asList, index);
    }

    /* JADX INFO: renamed from: indexOf-WZ4Q5Ns, reason: not valid java name */
    public int m799indexOfWZ4Q5Ns(int element) {
        return ArraysKt.indexOf(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: lastIndexOf-WZ4Q5Ns, reason: not valid java name */
    public int m800lastIndexOfWZ4Q5Ns(int element) {
