...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
    ...
    public <T> T[] toArray(T[] destination) {
        ...
        E[] eArr = this.array;
        if (length < i) {
            T[] tArr = (T[]) Arrays.copyOfRange(eArr, this.offset, this.offset + this.length, destination.getClass());
    ...
    private final E removeAtInternal(int i) {
        if (this.backing != null) {
            E eRemoveAtInternal = this.backing.removeAtInternal(i);
            this.length--;
    ...
    private final int retainOrRemoveAllInternal(int rangeOffset, int rangeLength, Collection<? extends E> elements, boolean retain) {
        ...
        while (true) {
            ...
            if (i < rangeLength) {
                ...
                ArraysKt.copyInto(eArr, this.array, rangeOffset + j, rangeOffset + rangeLength, this.length);
