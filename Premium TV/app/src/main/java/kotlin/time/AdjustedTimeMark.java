...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo1599elapsedNowUwyO8pc() {
        return Duration.m1642minusLRDsOJo(this.mark.mo1599elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1601plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1643plusLRDsOJo(this.adjustment, duration), null);
    }
}
