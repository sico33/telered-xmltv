...
public final /* data */ class TimedValue<T> {
    ...
    public final TimedValue<T> m1761copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m1612equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        return ((this.value == null ? 0 : this.value.hashCode()) * 31) + Duration.m1635hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1656toStringimpl(this.duration)) + ')';
    }
