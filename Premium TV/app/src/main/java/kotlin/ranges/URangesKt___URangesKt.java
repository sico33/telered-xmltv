...
class URangesKt___URangesKt {
    ...
    public static final UInt firstOrNull(UIntProgression $this$firstOrNull) {
        ...
        return UInt.m382boximpl($this$firstOrNull.getFirst());
    }
    ...
    public static final ULong firstOrNull(ULongProgression $this$firstOrNull) {
        ...
        return ULong.m460boximpl($this$firstOrNull.getFirst());
    }
    ...
    public static final UInt lastOrNull(UIntProgression $this$lastOrNull) {
        ...
        return UInt.m382boximpl($this$lastOrNull.getLast());
    }
    ...
    public static final ULong lastOrNull(ULongProgression $this$lastOrNull) {
        ...
        return ULong.m460boximpl($this$lastOrNull.getLast());
    }
    ...
    public static final UInt randomOrNull(UIntRange $this$randomOrNull, Random random) {
        ...
        return UInt.m382boximpl(URandomKt.nextUInt(random, $this$randomOrNull));
    }
    ...
    public static final ULong randomOrNull(ULongRange $this$randomOrNull, Random random) {
        ...
        return ULong.m460boximpl(URandomKt.nextULong(random, $this$randomOrNull));
    }

    /* JADX INFO: renamed from: contains-biwQdVI, reason: not valid java name */
    private static final boolean m1556containsbiwQdVI(UIntRange contains, UInt element) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return element != null && contains.m1527containsWZ4Q5Ns(element.getData());
    }

    /* JADX INFO: renamed from: contains-GYNo2lE, reason: not valid java name */
    private static final boolean m1552containsGYNo2lE(ULongRange contains, ULong element) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return element != null && contains.m1534containsVKZWuLQ(element.getData());
    }

    /* JADX INFO: renamed from: contains-68kG9v0, reason: not valid java name */
    public static final boolean m1551contains68kG9v0(UIntRange contains, byte value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1527containsWZ4Q5Ns(UInt.m388constructorimpl(value & 255));
    }

    /* JADX INFO: renamed from: contains-ULb-yJY, reason: not valid java name */
    public static final boolean m1554containsULbyJY(ULongRange contains, byte value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1534containsVKZWuLQ(ULong.m466constructorimpl(((long) value) & 255));
    }

    /* JADX INFO: renamed from: contains-Gab390E, reason: not valid java name */
    public static final boolean m1553containsGab390E(ULongRange contains, int value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1534containsVKZWuLQ(ULong.m466constructorimpl(((long) value) & 4294967295L));
    }

    /* JADX INFO: renamed from: contains-fz5IDCE, reason: not valid java name */
    public static final boolean m1557containsfz5IDCE(UIntRange contains, long value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return ULong.m466constructorimpl(value >>> 32) == 0 && contains.m1527containsWZ4Q5Ns(UInt.m388constructorimpl((int) value));
    }

    /* JADX INFO: renamed from: contains-ZsK3CEQ, reason: not valid java name */
    public static final boolean m1555containsZsK3CEQ(UIntRange contains, short value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1527containsWZ4Q5Ns(UInt.m388constructorimpl(65535 & value));
    }

    /* JADX INFO: renamed from: contains-uhHAxoY, reason: not valid java name */
    public static final boolean m1558containsuhHAxoY(ULongRange contains, short value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1534containsVKZWuLQ(ULong.m466constructorimpl(((long) value) & 65535));
    }

    /* JADX INFO: renamed from: downTo-Kr8caGY, reason: not valid java name */
    public static final UIntProgression m1561downToKr8caGY(byte $this$downTo_u2dKr8caGY, byte to) {
        return UIntProgression.INSTANCE.m1525fromClosedRangeNkh28Cs(UInt.m388constructorimpl($this$downTo_u2dKr8caGY & 255), UInt.m388constructorimpl(to & 255), -1);
    }

    /* JADX INFO: renamed from: downTo-J1ME1BU, reason: not valid java name */
    public static final UIntProgression m1560downToJ1ME1BU(int $this$downTo_u2dJ1ME1BU, int to) {
        return UIntProgression.INSTANCE.m1525fromClosedRangeNkh28Cs($this$downTo_u2dJ1ME1BU, to, -1);
    }

    /* JADX INFO: renamed from: downTo-eb3DHEI, reason: not valid java name */
    public static final ULongProgression m1562downToeb3DHEI(long $this$downTo_u2deb3DHEI, long to) {
        return ULongProgression.INSTANCE.m1532fromClosedRange7ftBX0g($this$downTo_u2deb3DHEI, to, -1L);
    }

    /* JADX INFO: renamed from: downTo-5PvTz6A, reason: not valid java name */
    public static final UIntProgression m1559downTo5PvTz6A(short $this$downTo_u2d5PvTz6A, short to) {
        return UIntProgression.INSTANCE.m1525fromClosedRangeNkh28Cs(UInt.m388constructorimpl($this$downTo_u2d5PvTz6A & UShort.MAX_VALUE), UInt.m388constructorimpl(65535 & to), -1);
    }

    public static final UIntProgression reversed(UIntProgression $this$reversed) {
        Intrinsics.checkNotNullParameter($this$reversed, "<this>");
        return UIntProgression.INSTANCE.m1525fromClosedRangeNkh28Cs($this$reversed.getLast(), $this$reversed.getFirst(), -$this$reversed.getStep());
    }

    public static final ULongProgression reversed(ULongProgression $this$reversed) {
        Intrinsics.checkNotNullParameter($this$reversed, "<this>");
        return ULongProgression.INSTANCE.m1532fromClosedRange7ftBX0g($this$reversed.getLast(), $this$reversed.getFirst(), -$this$reversed.getStep());
    }
    ...
    public static final UIntProgression step(UIntProgression $this$step, int step) {
        ...
        return UIntProgression.INSTANCE.m1525fromClosedRangeNkh28Cs($this$step.getFirst(), $this$step.getLast(), $this$step.getStep() > 0 ? step : -step);
    }
    ...
    public static final ULongProgression step(ULongProgression $this$step, long step) {
        ...
        return ULongProgression.INSTANCE.m1532fromClosedRange7ftBX0g($this$step.getFirst(), $this$step.getLast(), $this$step.getStep() > 0 ? step : -step);
    }

    /* JADX INFO: renamed from: until-Kr8caGY, reason: not valid java name */
    public static final UIntRange m1565untilKr8caGY(byte $this$until_u2dKr8caGY, byte to) {
        return Intrinsics.compare(to & 255, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m388constructorimpl($this$until_u2dKr8caGY & 255), UInt.m388constructorimpl(UInt.m388constructorimpl(to & 255) - 1), null);
    }

    /* JADX INFO: renamed from: until-J1ME1BU, reason: not valid java name */
    public static final UIntRange m1564untilJ1ME1BU(int $this$until_u2dJ1ME1BU, int to) {
        return UnsignedKt.uintCompare(to, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange($this$until_u2dJ1ME1BU, UInt.m388constructorimpl(to - 1), null);
    }

    /* JADX INFO: renamed from: until-eb3DHEI, reason: not valid java name */
    public static final ULongRange m1566untileb3DHEI(long $this$until_u2deb3DHEI, long to) {
        return UnsignedKt.ulongCompare(to, 0L) <= 0 ? ULongRange.INSTANCE.getEMPTY() : new ULongRange($this$until_u2deb3DHEI, ULong.m466constructorimpl(to - ULong.m466constructorimpl(1L)), null);
    }

    /* JADX INFO: renamed from: until-5PvTz6A, reason: not valid java name */
    public static final UIntRange m1563until5PvTz6A(short $this$until_u2d5PvTz6A, short to) {
        return Intrinsics.compare(to & UShort.MAX_VALUE, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m388constructorimpl($this$until_u2d5PvTz6A & UShort.MAX_VALUE), UInt.m388constructorimpl(UInt.m388constructorimpl(65535 & to) - 1), null);
    }

    /* JADX INFO: renamed from: coerceAtLeast-J1ME1BU, reason: not valid java name */
    public static final int m1538coerceAtLeastJ1ME1BU(int $this$coerceAtLeast_u2dJ1ME1BU, int minimumValue) {
    ...
    public static final long m1540coerceAtLeasteb3DHEI(long $this$coerceAtLeast_u2deb3DHEI, long minimumValue) {
    ...
    public static final byte m1539coerceAtLeastKr8caGY(byte $this$coerceAtLeast_u2dKr8caGY, byte minimumValue) {
    ...
    public static final short m1537coerceAtLeast5PvTz6A(short $this$coerceAtLeast_u2d5PvTz6A, short minimumValue) {
    ...
    public static final int m1542coerceAtMostJ1ME1BU(int $this$coerceAtMost_u2dJ1ME1BU, int maximumValue) {
    ...
    public static final long m1544coerceAtMosteb3DHEI(long $this$coerceAtMost_u2deb3DHEI, long maximumValue) {
    ...
    public static final byte m1543coerceAtMostKr8caGY(byte $this$coerceAtMost_u2dKr8caGY, byte maximumValue) {
    ...
    public static final short m1541coerceAtMost5PvTz6A(short $this$coerceAtMost_u2d5PvTz6A, short maximumValue) {
    ...
    public static final int m1547coerceInWZ9TVnA(int $this$coerceIn_u2dWZ9TVnA, int minimumValue, int maximumValue) {
        if (UnsignedKt.uintCompare(minimumValue, maximumValue) > 0) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UInt.m433toStringimpl(maximumValue)) + " is less than minimum " + ((Object) UInt.m433toStringimpl(minimumValue)) + '.');
        }
    ...
    public static final long m1549coerceInsambcqE(long $this$coerceIn_u2dsambcqE, long minimumValue, long maximumValue) {
        if (UnsignedKt.ulongCompare(minimumValue, maximumValue) > 0) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) ULong.m511toStringimpl(maximumValue)) + " is less than minimum " + ((Object) ULong.m511toStringimpl(minimumValue)) + '.');
        }
    ...
    public static final byte m1548coerceInb33U2AM(byte $this$coerceIn_u2db33U2AM, byte minimumValue, byte maximumValue) {
        if (Intrinsics.compare(minimumValue & 255, maximumValue & 255) > 0) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UByte.m355toStringimpl(maximumValue)) + " is less than minimum " + ((Object) UByte.m355toStringimpl(minimumValue)) + '.');
        }
    ...
    public static final short m1546coerceInVKSA0NQ(short $this$coerceIn_u2dVKSA0NQ, short minimumValue, short maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UShort.m615toStringimpl(maximumValue)) + " is less than minimum " + ((Object) UShort.m615toStringimpl(minimumValue)) + '.');
    }

    /* JADX INFO: renamed from: coerceIn-wuiCnnA, reason: not valid java name */
    public static final int m1550coerceInwuiCnnA(int $this$coerceIn_u2dwuiCnnA, ClosedRange<UInt> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt.coerceIn(UInt.m382boximpl($this$coerceIn_u2dwuiCnnA), (ClosedFloatingPointRange<UInt>) range)).getData();
        }
        if (range.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
        }
        if (UnsignedKt.uintCompare($this$coerceIn_u2dwuiCnnA, ((UInt) range.getStart()).getData()) < 0) {
            return ((UInt) range.getStart()).getData();
        }
        return UnsignedKt.uintCompare($this$coerceIn_u2dwuiCnnA, ((UInt) range.getEndInclusive()).getData()) > 0 ? ((UInt) range.getEndInclusive()).getData() : $this$coerceIn_u2dwuiCnnA;
    }

    /* JADX INFO: renamed from: coerceIn-JPwROB0, reason: not valid java name */
    public static final long m1545coerceInJPwROB0(long $this$coerceIn_u2dJPwROB0, ClosedRange<ULong> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt.coerceIn(ULong.m460boximpl($this$coerceIn_u2dJPwROB0), (ClosedFloatingPointRange<ULong>) range)).getData();
        }
        if (range.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
        }
        if (UnsignedKt.ulongCompare($this$coerceIn_u2dJPwROB0, ((ULong) range.getStart()).getData()) < 0) {
            return ((ULong) range.getStart()).getData();
        }
        return UnsignedKt.ulongCompare($this$coerceIn_u2dJPwROB0, ((ULong) range.getEndInclusive()).getData()) > 0 ? ((ULong) range.getEndInclusive()).getData() : $this$coerceIn_u2dJPwROB0;
    }
}
