...
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u001c\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010(\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0017\u0018\u0000 \u00172\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u0017B\"\b\u0000\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0004\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0006ø\u0001\u0000¢\u0006\u0002\u0010\u0007J\u0013\u0010\r\u001a\u00020\u000e2\b\u0010\u000f\u001a\u0004\u0018\u00010\u0010H\u0096\u0002J\b\u0010\u0011\u001a\u00020\u0006H\u0016J\b\u0010\u0012\u001a\u00020\u000eH\u0016J\u0012\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00020\u0014H\u0086\u0002ø\u0001\u0000J\b\u0010\u0015\u001a\u00020\u0016H\u0016R\u0013\u0010\b\u001a\u00020\u0002ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\n\u0002\u0010\tR\u0013\u0010\n\u001a\u00020\u0002ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\n\u0002\u0010\tR\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fø\u0001\u0000\u0082\u0002\b\n\u0002\b\u0019\n\u0002\b!¨\u0006\u0018"}, d2 = {"Lkotlin/ranges/UIntProgression;", "", "Lkotlin/UInt;", TtmlNode.START, "endInclusive", "step", "", "(IIILkotlin/jvm/internal/DefaultConstructorMarker;)V", "first", "I", "last", "getStep", "()I", "equals", "", "other", "", "hashCode", "isEmpty", "iterator", "", "toString", "", "Companion", "kotlin-stdlib"}, k = 1, mv = {1, 7, 1}, xi = 48)
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int start, int endInclusive, int step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1509getProgressionLastElementNkh28Cs(start, endInclusive, step);
        this.step = step;
    }
    ...
    public boolean isEmpty() {
        ...
        int i2 = this.first;
        if (i > 0) {
            if (UnsignedKt.uintCompare(i2, this.last) > 0) {
                return true;
            }
        } else if (UnsignedKt.uintCompare(i2, this.last) < 0) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) UInt.m433toStringimpl(this.first)).append("..").append((Object) UInt.m433toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) UInt.m433toStringimpl(this.first)).append(" downTo ").append((Object) UInt.m433toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1525fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
