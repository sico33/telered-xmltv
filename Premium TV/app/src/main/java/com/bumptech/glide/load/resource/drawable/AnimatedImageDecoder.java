...
public final class AnimatedImageDecoder {
    ...
    Resource<Drawable> decode(ImageDecoder$Source imageDecoder$Source, int i, int i2, Options options) throws IOException {
        Drawable drawableDecodeDrawable = ImageDecoder.decodeDrawable(imageDecoder$Source, new DefaultOnHeaderDecodedListener(i, i2, options));
