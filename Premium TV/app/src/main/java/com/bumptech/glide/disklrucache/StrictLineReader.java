...
class StrictLineReader implements Closeable {
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.in) {
            ...
            while (i2 != this.end) {
                if (this.buf[i2] == 10) {
                    string = new String(this.buf, this.pos, ((i2 == this.pos || this.buf[i2 + (-1)] != 13) ? i2 : i2 - 1) - this.pos, this.charset.name());
                    this.pos = i2 + 1;
                } else {
                    i2++;
                }
            ...
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream(this, (this.end - this.pos) + 80) { // from class: com.bumptech.glide.disklrucache.StrictLineReader.1
                ...
                public String toString() {
                    try {
                        return new String(this.buf, 0, (this.count <= 0 || this.buf[this.count + (-1)] != 13) ? this.count : this.count - 1, this.this$0.charset.name());
