...
final class RegistryFactory {
    ...
    static GlideSuppliers.GlideSupplier<Registry> lazilyCreateAndInitializeRegistry(Glide glide, List<GlideModule> list, AppGlideModule appGlideModule) {
        return new GlideSuppliers.GlideSupplier<Registry>(glide, list, appGlideModule) { // from class: com.bumptech.glide.RegistryFactory.1
