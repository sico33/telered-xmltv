...
final class SparseImmutableTable<R, C, V> extends RegularImmutableTable<R, C, V> {
    ...
    SparseImmutableTable(ImmutableList<Table.Cell<R, C, V>> immutableList, ImmutableSet<R> immutableSet, ImmutableSet<C> immutableSet2) {
        ...
        while (true) {
            ...
            iArr[i2] = ((Integer) Objects.requireNonNull((Integer) immutableMapIndexMap.get(rowKey))).intValue();
    ...
    Object writeReplace() {
        ...
        while (true) {
            ...
            iArr[i2] = ((Integer) Objects.requireNonNull((Integer) immutableMapIndexMap.get(it.next().getColumnKey()))).intValue();
            i = i2 + 1;
        }
    }
}
