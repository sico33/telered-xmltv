...
abstract class WrappingExecutorService implements ExecutorService {
    ...
    protected Runnable wrapTask(Runnable runnable) {
        ...
        return new Runnable(callableWrapTask) { // from class: com.google.common.util.concurrent.WrappingExecutorService$$ExternalSyntheticLambda0
            public final Callable f$0;

            {
                this.f$0 = callableWrapTask;
            }
