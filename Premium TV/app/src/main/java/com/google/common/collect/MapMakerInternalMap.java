...
class MapMakerInternalMap<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    static final class CleanupMapTask implements Runnable {
        ...
        public void run() {
            ...
            Segment<?, ?, E, S>[] segmentArr = mapMakerInternalMap.segments;
            for (Segment<?, ?, E, S> segment : segmentArr) {
                segment.runCleanup();
            }
        }
    }
    ...
    static abstract class Segment<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends ReentrantLock {
        ...
        boolean containsKey(Object obj, int i) {
            ...
            boolean z = false;
            try {
                if (this.count != 0 && (liveEntry = getLiveEntry(obj, i)) != null && liveEntry.getValue() != null) {
                    z = true;
                }
                return z;
            } finally {
            ...
            while (i4 < length) {
                ...
                if (e != null) {
                    ...
                    if (next == null) {
                        ...
                        InternalEntry next2 = e;
                        i = i3;
                        while (next2 != internalEntry) {
                            int hash3 = next2.getHash() & length2;
                            InternalEntry internalEntryCopyEntry = copyEntry(next2, (InternalEntry) atomicReferenceArrayNewEntryArray.get(hash3));
        ...
        E removeFromChain(E e, E e2) {
            ...
            while (e != e2) {
                ...
                if (internalEntryCopyEntry != null) {
                    ...
                    i = i2 - 1;
                    internalEntryCopyEntry = internalEntry;
                }
                e = (E) e.getNext();
                i2 = i;
    ...
    private MapMakerInternalMap(MapMaker mapMaker, InternalEntryHelper<K, V, E, S> internalEntryHelper) {
        ...
        int i4 = iMin / i2;
        while (i < (i2 * i4 < iMin ? i4 + 1 : i4)) {
            i <<= 1;
        }
        for (int i5 = 0; i5 < this.segments.length; i5++) {
            this.segments[i5] = createSegment(i);
        }
    }
