...
public abstract class Striped<L> {
    ...
    static class SmallLazyStriped<L> extends PowerOfTwoStriped<L> {
        ...
        public L getAt(int i) {
            ...
            ArrayReference arrayReference2 = new ArrayReference(l, i, this.queue);
    ...
    public static Striped<Semaphore> lazyWeakSemaphore(int i, final int i2) {
        return lazy(i, new Supplier(i2) { // from class: com.google.common.util.concurrent.Striped$$ExternalSyntheticLambda3
    ...
    public static Striped<Semaphore> semaphore(int i, final int i2) {
        return custom(i, new Supplier(i2) { // from class: com.google.common.util.concurrent.Striped$$ExternalSyntheticLambda2
            public final int f$0;
