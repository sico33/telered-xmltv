...
public final class ImmutableNetwork<N, E> extends StandardNetwork<N, E> {
    ...
    private static <N, E> Function<E, N> adjacentNodeFn(final Network<N, E> network, final N n) {
        return new Function(network, n) { // from class: com.google.common.graph.ImmutableNetwork$$ExternalSyntheticLambda1
    ...
    private static <N, E> Function<E, N> sourceNodeFn(final Network<N, E> network) {
        return new Function(network) { // from class: com.google.common.graph.ImmutableNetwork$$ExternalSyntheticLambda0
            public final Network f$0;
    ...
    private static <N, E> Function<E, N> targetNodeFn(final Network<N, E> network) {
        return new Function(network) { // from class: com.google.common.graph.ImmutableNetwork$$ExternalSyntheticLambda2
            public final Network f$0;
