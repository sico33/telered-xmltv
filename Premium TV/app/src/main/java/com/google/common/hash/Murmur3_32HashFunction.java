...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int i, long j) {
            this.buffer |= (4294967295L & j) << this.shift;
            this.shift += i * 8;
            this.length += i;
            if (this.shift >= 32) {
        ...
        public Hasher putString(CharSequence charSequence, Charset charset) {
            ...
            while (i + 4 <= length) {
                ...
                update(4, cCharAt | (cCharAt2 << '\b') | (cCharAt3 << 16) | (cCharAt4 << 24));
                i += 4;
            }
            while (i < length) {
    ...
    public HashCode hashBytes(byte[] bArr, int i, int i2) {
        ...
        int i5 = 0;
        while (i5 + 4 <= i2) {
            int iMixH1 = mixH1(i4, mixK1(getIntLittleEndian(bArr, i + i5)));
            i5 += 4;
            i4 = iMixH1;
        }
        int i6 = i5;
        int i7 = 0;
        while (i6 < i2) {
            i7 ^= UnsignedBytes.toInt(bArr[i + i6]) << i3;
            i6++;
            i3 += 8;
        }
        return fmix(mixK1(i7) ^ i4, i2);
    }
    ...
    public HashCode hashString(CharSequence charSequence, Charset charset) {
        ...
        while (i4 + 4 <= length) {
            ...
            char cCharAt3 = charSequence.charAt(i4 + 2);
            char cCharAt4 = charSequence.charAt(i4 + 3);
            if (cCharAt >= 128 || cCharAt2 >= 128 || cCharAt3 >= 128 || cCharAt4 >= 128) {
                break;
            }
            iMixH1 = mixH1(iMixH1, mixK1(cCharAt | (cCharAt2 << '\b') | (cCharAt3 << 16) | (cCharAt4 << 24)));
            i4 += 4;
            i5 += 4;
        }
        int i6 = i5;
        ...
        while (i8 < length) {
            ...
            if (cCharAt5 < 128) {
                long j3 = j2 | (((long) cCharAt5) << i7);
                i = i7 + 8;
                i2 = i8;
                i3 = i6 + 1;
                j = j3;
            } else if (cCharAt5 < 2048) {
                long jCharToTwoUtf8Bytes = j2 | (charToTwoUtf8Bytes(cCharAt5) << i7);
                i = i7 + 16;
                i2 = i8;
                i3 = i6 + 2;
                j = jCharToTwoUtf8Bytes;
            } else if (cCharAt5 < 55296 || cCharAt5 > 57343) {
                long jCharToThreeUtf8Bytes = j2 | (charToThreeUtf8Bytes(cCharAt5) << i7);
                i = i7 + 24;
                i2 = i8;
                i3 = i6 + 3;
                j = jCharToThreeUtf8Bytes;
            } else {
                ...
                int i9 = i8 + 1;
                long jCodePointToFourUtf8Bytes = j2 | (codePointToFourUtf8Bytes(iCodePointAt) << i7);
                ...
                i3 = i6 + 4;
                i = i7;
                j = jCodePointToFourUtf8Bytes;
            }
            if (i >= 32) {
                iMixH1 = mixH1(iMixH1, mixK1((int) j));
                j >>>= 32;
                i -= 32;
            }
            i6 = i3;
        ...
        return fmix(mixK1((int) j2) ^ iMixH1, i6);
    }
