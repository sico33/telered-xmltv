...
public final class Maps {
    ...
    static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        private static <K, V> Predicate<Map.Entry<V, K>> inversePredicate(Predicate<? super Map.Entry<K, V>> predicate) {
            return new Predicate<Map.Entry<V, K>>(predicate) { // from class: com.google.common.collect.Maps.FilteredEntryBiMap.1
    ...
    static class FilteredEntryMap<K, V> extends AbstractFilteredMap<K, V> {
        ...
        private class EntrySet extends ForwardingSet<Map.Entry<K, V>> {
            ...
            /* JADX INFO: renamed from: com.google.common.collect.Maps$FilteredEntryMap$EntrySet$1, reason: invalid class name */
            class AnonymousClass1 extends TransformedIterator<Map.Entry<K, V>, Map.Entry<K, V>> {
                final EntrySet this$1;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                AnonymousClass1(EntrySet entrySet, Iterator it) {
                    super(it);
                ...
                public Map.Entry<K, V> transform(Map.Entry<K, V> entry) {
                    return new ForwardingMapEntry<K, V>(this, entry) { // from class: com.google.common.collect.Maps.FilteredEntryMap.EntrySet.1.1
            ...
            public Iterator<Map.Entry<K, V>> iterator() {
                return new AnonymousClass1(this, this.this$0.filteredEntrySet.iterator());
            }
        }
        ...
        class KeySet extends KeySet<K, V> {
            ...
            @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean removeAll(Collection<?> collection) {
                return FilteredEntryMap.removeAllKeys(this.this$0.unfiltered, this.this$0.predicate, collection);
            }

            @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean retainAll(Collection<?> collection) {
                return FilteredEntryMap.retainAllKeys(this.this$0.unfiltered, this.this$0.predicate, collection);
            }
    ...
    private static class FilteredEntryNavigableMap<K, V> extends AbstractNavigableMap<K, V> {
        ...
        public NavigableSet<K> navigableKeySet() {
            return new NavigableKeySet<K, V>(this, this) { // from class: com.google.common.collect.Maps.FilteredEntryNavigableMap.1
                ...
                @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
                public boolean removeAll(Collection<?> collection) {
                    return FilteredEntryMap.removeAllKeys(this.this$0.unfiltered, this.this$0.entryPredicate, collection);
                }

                @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
                public boolean retainAll(Collection<?> collection) {
                    return FilteredEntryMap.retainAllKeys(this.this$0.unfiltered, this.this$0.entryPredicate, collection);
                }
            };
        }
    ...
    static <K, V1, V2> Function<Map.Entry<K, V1>, Map.Entry<K, V2>> asEntryToEntryFunction(EntryTransformer<? super K, ? super V1, V2> entryTransformer) {
        ...
        return new Function<Map.Entry<K, V1>, Map.Entry<K, V2>>(entryTransformer) { // from class: com.google.common.collect.Maps.13
    ...
    static <K, V1, V2> Function<Map.Entry<K, V1>, V2> asEntryToValueFunction(EntryTransformer<? super K, ? super V1, V2> entryTransformer) {
        Preconditions.checkNotNull(entryTransformer);
        return new Function<Map.Entry<K, V1>, V2>(entryTransformer) { // from class: com.google.common.collect.Maps.11
            final EntryTransformer val$transformer;
    ...
    static <K, V1, V2> EntryTransformer<K, V1, V2> asEntryTransformer(Function<? super V1, V2> function) {
        ...
        return new EntryTransformer<K, V1, V2>(function) { // from class: com.google.common.collect.Maps.9
    ...
    static <K, V> Iterator<Map.Entry<K, V>> asMapEntryIterator(Set<K> set, Function<? super K, V> function) {
        return new TransformedIterator<K, Map.Entry<K, V>>(set.iterator(), function) { // from class: com.google.common.collect.Maps.3
            final Function val$function;
    ...
    static <K, V1, V2> Function<V1, V2> asValueToValueFunction(EntryTransformer<? super K, V1, V2> entryTransformer, @ParametricNullness K k) {
        Preconditions.checkNotNull(entryTransformer);
        return new Function<V1, V2>(entryTransformer, k) { // from class: com.google.common.collect.Maps.10
    ...
    public static <E> NavigableSet<E> removeOnlyNavigableSet(NavigableSet<E> navigableSet) {
        return new ForwardingNavigableSet<E>(navigableSet) { // from class: com.google.common.collect.Maps.6
    ...
    public static <E> Set<E> removeOnlySet(Set<E> set) {
        return new ForwardingSet<E>(set) { // from class: com.google.common.collect.Maps.4
            final Set val$set;
    ...
    public static <E> SortedSet<E> removeOnlySortedSet(SortedSet<E> sortedSet) {
        return new ForwardingSortedSet<E>(sortedSet) { // from class: com.google.common.collect.Maps.5
    ...
    static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(java.util.function.Function<? super T, ? extends K> function, java.util.function.Function<? super T, ? extends V> function2) {
        return CollectCollectors.toImmutableEnumMap(function, function2);
    }

    static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(java.util.function.Function<? super T, ? extends K> function, java.util.function.Function<? super T, ? extends V> function2, BinaryOperator<V> binaryOperator) {
    ...
    static <V2, K, V1> Map.Entry<K, V2> transformEntry(EntryTransformer<? super K, ? super V1, V2> entryTransformer, Map.Entry<K, V1> entry) {
        ...
        return new AbstractMapEntry<K, V2>(entry, entryTransformer) { // from class: com.google.common.collect.Maps.12
            final Map.Entry val$entry;
            final EntryTransformer val$transformer;
    ...
    static <K, V> Map.Entry<K, V> unmodifiableEntry(Map.Entry<? extends K, ? extends V> entry) {
        Preconditions.checkNotNull(entry);
        return new AbstractMapEntry<K, V>(entry) { // from class: com.google.common.collect.Maps.7
            final Map.Entry val$entry;
    ...
    static <K, V> UnmodifiableIterator<Map.Entry<K, V>> unmodifiableEntryIterator(Iterator<Map.Entry<K, V>> it) {
        return new UnmodifiableIterator<Map.Entry<K, V>>(it) { // from class: com.google.common.collect.Maps.8
