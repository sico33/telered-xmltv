...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
    ...
    public long approximateElementCount() {
        long jBitSize = this.bits.bitSize();
        return DoubleMath.roundToLong((jBitSize * (-Math.log1p(-(this.bits.bitCount() / jBitSize)))) / ((double) this.numHashFunctions), RoundingMode.HALF_UP);
    }
