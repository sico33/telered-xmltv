...
public abstract class ImmutableMultimap<K, V> extends BaseImmutableMultimap<K, V> implements Serializable {
    ...
    public static class Builder<K, V> {
        ...
        public Builder<K, V> put(K k, V v) {
            ...
            Collection<V> collectionNewMutableValueCollection = this.builderMap.get(k);
            if (collectionNewMutableValueCollection == null) {
                Map<K, Collection<V>> map = this.builderMap;
                collectionNewMutableValueCollection = newMutableValueCollection();
                map.put(k, collectionNewMutableValueCollection);
            }
            collectionNewMutableValueCollection.add(v);
            return this;
        }
    ...
    public UnmodifiableIterator<V> valueIterator() {
        return new UnmodifiableIterator<V>(this) { // from class: com.google.common.collect.ImmutableMultimap.2
            ...
            {
                this.this$0 = this;
                this.valueCollectionItr = this.this$0.map.values().iterator();
            }
