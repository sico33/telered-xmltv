...
abstract class AbstractDirectedNetworkConnections<N, E> implements NetworkConnections<N, E> {
    ...
    public Set<E> incidentEdges() {
        return new AbstractSet<E>(this) { // from class: com.google.common.graph.AbstractDirectedNetworkConnections.1
            ...
            public UnmodifiableIterator<E> iterator() {
                int i = this.this$0.selfLoopCount;
                AbstractDirectedNetworkConnections abstractDirectedNetworkConnections = this.this$0;
                return Iterators.unmodifiableIterator((i == 0 ? Iterables.concat(abstractDirectedNetworkConnections.inEdgeMap.keySet(), this.this$0.outEdgeMap.keySet()) : Sets.union(abstractDirectedNetworkConnections.inEdgeMap.keySet(), this.this$0.outEdgeMap.keySet())).iterator());
            }
