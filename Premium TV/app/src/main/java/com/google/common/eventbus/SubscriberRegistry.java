...
final class SubscriberRegistry {
    ...
    void register(Object obj) {
        CopyOnWriteArraySet<Subscriber> copyOnWriteArraySet;
        for (Map.Entry<Class<?>, Collection<Subscriber>> entry : findAllSubscribers(obj).asMap().entrySet()) {
            ...
            CopyOnWriteArraySet<Subscriber> copyOnWriteArraySet2 = this.subscribers.get(key);
            if (copyOnWriteArraySet2 == null) {
                CopyOnWriteArraySet<Subscriber> copyOnWriteArraySet3 = new CopyOnWriteArraySet<>();
                copyOnWriteArraySet = (CopyOnWriteArraySet) MoreObjects.firstNonNull(this.subscribers.putIfAbsent(key, copyOnWriteArraySet3), copyOnWriteArraySet3);
            } else {
