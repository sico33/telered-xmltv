...
public final class Tables {
    ...
    private static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        Function<Table.Cell<R, C, V1>, Table.Cell<R, C, V2>> cellFunction() {
            return new Function<Table.Cell<R, C, V1>, Table.Cell<R, C, V2>>(this) { // from class: com.google.common.collect.Tables.TransformedTable.1
        ...
        public Map<C, Map<R, V2>> columnMap() {
            return Maps.transformValues(this.fromTable.columnMap(), new Function<Map<R, V1>, Map<R, V2>>(this) { // from class: com.google.common.collect.Tables.TransformedTable.3
                final TransformedTable this$0;
        ...
        public Map<R, Map<C, V2>> rowMap() {
            return Maps.transformValues(this.fromTable.rowMap(), new Function<Map<C, V1>, Map<C, V2>>(this) { // from class: com.google.common.collect.Tables.TransformedTable.2
                final TransformedTable this$0;
