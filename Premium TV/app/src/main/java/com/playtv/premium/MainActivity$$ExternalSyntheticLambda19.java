...
@LambdaMethod(holder = "Lcom/playtv/premium/MainActivity;", method = "lambda$buildUi$3", proto = "(Landroid/view/View;)V")
...
public final /* synthetic */ class MainActivity$$ExternalSyntheticLambda19 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        this.f$0.m241lambda$buildUi$3$complaytvpremiumMainActivity(view);
    }
}
