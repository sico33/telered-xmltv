...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    void moveToState(Fragment f, int newState) {
        FragmentAnim.AnimationOrAnimator anim;
        ViewGroup container;
        View view;
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) {
        ...
        if (!allowReordering && this.mCurState >= 1) {
            if (!USE_STATE_MANAGER) {
                FragmentTransition.startTransitions(this.mHost.getContext(), this.mContainer, arrayList, isRecordPop, i, i2, false, this.mFragmentTransitionCallback);
                arrayList = arrayList;
                arrayList2 = isRecordPop;
                i = i;
                i2 = i2;
            } else {
                for (int index = startIndex; index < i2; index++) {
        ...
        if (USE_STATE_MANAGER) {
            boolean isPop2 = arrayList2.get(i2 - 1).booleanValue();
            for (int index2 = startIndex; index2 < i2; index2++) {
            ...
            Set<SpecialEffectsController> changedControllers = collectChangedControllers(arrayList, i, i2);
            ...
            if (postponeIndex == i || !allowReordering) {
                ...
                if (fragmentManager.mCurState < 1) {
                    ...
                    FragmentTransition.startTransitions(fragmentManager.mHost.getContext(), fragmentManager.mContainer, records, isRecordPop, i, postponeIndex, true, fragmentManager.mFragmentTransitionCallback);
                    arrayList = records;
                    arrayList2 = isRecordPop;
                }
