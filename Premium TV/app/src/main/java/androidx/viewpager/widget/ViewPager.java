    ...
    void populate(int newCurrentItem) {
        ...
        if (getWindowToken() != null) {
            ...
            if (curItem != null) {
                ...
                if (extraWidthRight < r15) {
                    ItemInfo ii4 = itemIndex2 < this.mItems.size() ? this.mItems.get(itemIndex2) : null;
                    float rightWidthNeeded = clientWidth <= 0 ? f : (getPaddingRight() / clientWidth) + 2.0f;
                    int pos2 = this.mCurItem + 1;
                    while (pos2 < N) {
                        if (extraWidthRight < rightWidthNeeded || pos2 <= endPos) {
                            float extraWidthRight2 = extraWidthRight;
                            pageLimit = pageLimit2;
                            if (ii4 != null && pos2 == ii4.position) {
                                extraWidthRight = extraWidthRight2 + ii4.widthFactor;
                                itemIndex2++;
                                ii4 = itemIndex2 < this.mItems.size() ? this.mItems.get(itemIndex2) : null;
                            } else {
                                ItemInfo ii5 = addNewItem(pos2, itemIndex2);
                                itemIndex2++;
                                float extraWidthRight3 = extraWidthRight2 + ii5.widthFactor;
                                ii4 = itemIndex2 < this.mItems.size() ? this.mItems.get(itemIndex2) : null;
                                extraWidthRight = extraWidthRight3;
                            }
                        } else {
                            if (ii4 == null) {
                                break;
                            }
                            float extraWidthRight4 = extraWidthRight;
                            if (pos2 != ii4.position || ii4.scrolling) {
                                pageLimit = pageLimit2;
                                extraWidthRight = extraWidthRight4;
                            } else {
            ...
            if (i < count) {
                ...
                if (child.getVisibility() == 8) {
                    ...
                    if (!lp.isDecor) {
                        ...
                        switch (hgrav) {
                            case 1:
                                int vgrav = (width - child.getMeasuredWidth()) / 2;
                                childLeft = Math.max(vgrav, paddingLeft);
                                break;
                            case 2:
                            case 4:
                            default:
                        ...
                        int height2 = childTop + child.getMeasuredHeight();
                        child.layout(childLeft2, childTop, measuredWidth, height2);
                        decorCount++;
                    }
                }
                i++;
                ...
                int height3 = height;
                int childWidth = (width2 - paddingLeft) - paddingRight;
                int i4 = 0;
                while (i4 < count) {
                        ...
                        if (lp2.isDecor) {
                            ...
                            if (ii == null) {
                                ...
                                if (lp2.needsMeasure) {
                                    ...
                                    int childWidth2 = (height3 - paddingTop) - paddingBottom;
                                    int heightSpec = View.MeasureSpec.makeMeasureSpec(childWidth2, 1073741824);
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            while (pos < lastPos) {
                ...
                if (this.mPageMargin + widthFactor > scrollX) {
                    ...
                    int scrollX2 = this.mBottomPageBounds;
                    drawable.setBounds(iRound, i, iRound2, scrollX2);
