...
public final class ExperimentalBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final class Builder {
        ...
        private static Map<Integer, Long> getInitialBitrateEstimatesForCountry(String countryCode) {
            int[] groupIndices = ExperimentalBandwidthMeter.getInitialBitrateCountryGroupAssignment(countryCode);
            Map<Integer, Long> result = new HashMap<>(8);
            result.put(0, 1000000L);
            result.put(2, ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI.get(groupIndices[0]));
            result.put(3, ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_2G.get(groupIndices[1]));
            result.put(4, ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_3G.get(groupIndices[2]));
            result.put(5, ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_4G.get(groupIndices[3]));
            result.put(10, ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_NSA.get(groupIndices[4]));
            result.put(9, ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_SA.get(groupIndices[5]));
            result.put(7, ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI.get(groupIndices[0]));
            return result;
        }
    }
