...
public interface ExoMediaDrm {
    ...
    public final /* synthetic */ class CC {
        public static void $default$setPlayerIdForSession(ExoMediaDrm _this, byte[] sessionId, PlayerId playerId) {
        }

        public static void $default$removeOfflineLicense(ExoMediaDrm _this, byte[] keySetId) {
