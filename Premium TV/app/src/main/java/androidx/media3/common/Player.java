...
public interface Player {
    ...
    public static final class PositionInfo {
        ...
        public boolean equals(Object o) {
            ...
            if (equalsForBundling(that) && Objects.equal(this.windowUid, that.windowUid) && Objects.equal(this.periodUid, that.periodUid)) {
                return true;
            }
            return false;
        }
        ...
        public boolean equalsForBundling(PositionInfo other) {
            return this.mediaItemIndex == other.mediaItemIndex && this.periodIndex == other.periodIndex && this.positionMs == other.positionMs && this.contentPositionMs == other.contentPositionMs && this.adGroupIndex == other.adGroupIndex && this.adIndexInAdGroup == other.adIndexInAdGroup && Objects.equal(this.mediaItem, other.mediaItem);
        }
        ...
        public Bundle toBundle(int controllerInterfaceVersion) {
            ...
            if (controllerInterfaceVersion < 3 || this.positionMs != 0) {
                bundle.putLong(FIELD_POSITION_MS, this.positionMs);
            }
            if (controllerInterfaceVersion < 3 || this.contentPositionMs != 0) {
    ...
    public interface Listener {
        ...
        public final /* synthetic */ class CC {
            ...
            public static void $default$onTimelineChanged(Listener _this, Timeline timeline, int reason) {
            }

            public static void $default$onMediaItemTransition(Listener _this, MediaItem mediaItem, int reason) {
            }
            ...
            public static void $default$onIsLoadingChanged(Listener _this, boolean isLoading) {
            }

            @Deprecated
            public static void $default$onLoadingChanged(Listener _this, boolean isLoading) {
            }

            public static void $default$onAvailableCommandsChanged(Listener _this, Commands availableCommands) {
            }

            public static void $default$onTrackSelectionParametersChanged(Listener _this, TrackSelectionParameters parameters) {
            }

            @Deprecated
            public static void $default$onPlayerStateChanged(Listener _this, boolean playWhenReady, int playbackState) {
            }

            public static void $default$onPlaybackStateChanged(Listener _this, int playbackState) {
            }

            public static void $default$onPlayWhenReadyChanged(Listener _this, boolean playWhenReady, int reason) {
            }

            public static void $default$onPlaybackSuppressionReasonChanged(Listener _this, int playbackSuppressionReason) {
            }

            public static void $default$onIsPlayingChanged(Listener _this, boolean isPlaying) {
            }

            public static void $default$onRepeatModeChanged(Listener _this, int repeatMode) {
            }

            public static void $default$onShuffleModeEnabledChanged(Listener _this, boolean shuffleModeEnabled) {
            }

            public static void $default$onPlayerError(Listener _this, PlaybackException error) {
            }

            public static void $default$onPlayerErrorChanged(Listener _this, PlaybackException error) {
            }

            @Deprecated
            public static void $default$onPositionDiscontinuity(Listener _this, int reason) {
            }

            public static void $default$onPositionDiscontinuity(Listener _this, PositionInfo oldPosition, PositionInfo newPosition, int reason) {
            }

            public static void $default$onPlaybackParametersChanged(Listener _this, PlaybackParameters playbackParameters) {
            }

            public static void $default$onSeekBackIncrementChanged(Listener _this, long seekBackIncrementMs) {
            }

            public static void $default$onSeekForwardIncrementChanged(Listener _this, long seekForwardIncrementMs) {
            }

            public static void $default$onMaxSeekToPreviousPositionChanged(Listener _this, long maxSeekToPreviousPositionMs) {
            }

            public static void $default$onAudioSessionIdChanged(Listener _this, int audioSessionId) {
            }

            public static void $default$onAudioAttributesChanged(Listener _this, AudioAttributes audioAttributes) {
            }

            public static void $default$onVolumeChanged(Listener _this, float volume) {
            }

            public static void $default$onSkipSilenceEnabledChanged(Listener _this, boolean skipSilenceEnabled) {
            }

            public static void $default$onDeviceInfoChanged(Listener _this, DeviceInfo deviceInfo) {
            }

            public static void $default$onDeviceVolumeChanged(Listener _this, int volume, boolean muted) {
            }

            public static void $default$onVideoSizeChanged(Listener _this, VideoSize videoSize) {
            }

            public static void $default$onSurfaceSizeChanged(Listener _this, int width, int height) {
            }
