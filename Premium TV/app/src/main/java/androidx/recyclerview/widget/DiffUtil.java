...
public class DiffUtil {
    ...
    private static Snake forward(Range range, Callback cb, CenteredArray forward, CenteredArray backward, int d) {
        ...
        for (int k = -d; k <= d; k += 2) {
            ...
            while (true) {
                if (startX >= range.oldListEnd || y >= range.newListEnd) {
                    break;
                }
    ...
    public static class DiffResult {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            if (listUpdateCallback2 instanceof BatchingListUpdateCallback) {
                batchingListUpdateCallback = (BatchingListUpdateCallback) listUpdateCallback2;
            } else {
                batchingListUpdateCallback = new BatchingListUpdateCallback(listUpdateCallback2);
                listUpdateCallback2 = batchingListUpdateCallback;
            }
            ...
            while (size >= 0) {
                ...
                while (true) {
                    ...
                    if ((i6 & 12) != 0) {
                        ...
                        listUpdateCallback2 = listUpdateCallback2;
                ...
                ListUpdateCallback listUpdateCallback3 = listUpdateCallback2;
                while (i4 > iEndY) {
                    i4--;
