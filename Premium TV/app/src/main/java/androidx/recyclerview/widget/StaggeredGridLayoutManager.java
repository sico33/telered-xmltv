...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (r0.mLayoutState.mInfinite || !r0.mRemainingSpans.isEmpty())) {
            View next = layoutState.next(recycler);
            LayoutParams layoutParams = (LayoutParams) next.getLayoutParams();
            int viewLayoutPosition = layoutParams.getViewLayoutPosition();
            int span = r0.mLazySpanLookup.getSpan(viewLayoutPosition);
            ?? r16 = span == -1 ? r9 : r8;
            if (r16 != 0) {
            ...
            if (layoutState.mLayoutDirection == r9) {
                decoratedMeasurement = layoutParams.mFullSpan ? r0.getMaxEnd(i7) : nextSpan.getEndLine(i7);
                ...
                minStart = layoutParams.mFullSpan ? r0.getMinStart(i7) : nextSpan.getStartLine(i7);
            ...
            if (layoutParams.mFullSpan && layoutState.mItemDirection == -1) {
                if (r16 != 0) {
                    ...
                    if (layoutState.mLayoutDirection == r9) {
                        i6 = (r0.areAllEndsEqual() ? 1 : 0) ^ r9;
                    } else {
                        i4 = (r0.areAllStartsEqual() ? 1 : 0) ^ r9;
                    }
                    if (i5 != 0) {
                        i5 = i4;
            ...
            int i10 = startAfterPadding2;
            if (r0.mOrientation == 1) {
                i2 = i10;
                r0.layoutDecoratedWithMargins(next, i2, i8, decoratedMeasurement2, i9);
                staggeredGridLayoutManager = this;
            } else {
                StaggeredGridLayoutManager staggeredGridLayoutManager3 = this;
                staggeredGridLayoutManager3.layoutDecoratedWithMargins(next, i8, i10, i9, decoratedMeasurement2);
                i2 = i10;
            ...
            if (z4) {
                ...
                staggeredGridLayoutManager.updateRemainingSpans(nextSpan, layoutState2.mLayoutDirection, i);
            }
            ...
            if (staggeredGridLayoutManager.mLayoutState.mStopInFocusable && next.hasFocusable()) {
                ...
                if (z5) {
                    ...
                    i3 = 0;
                    bitSet.set(nextSpan.mIndex, false);
                }
            } else {
                i3 = 0;
            }
        ...
        int i11 = r0.mLayoutState.mLayoutDirection;
        ...
        return maxEnd > 0 ? Math.min(layoutState.mAvailable, maxEnd) : r8 == true ? 1 : 0;
    }
